...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'electioncommision@gmail.com' ")
...
def TakeImages():
    ...
    assure_path_exists("VoterDetails/")
    assure_path_exists("TrainingImage/")
    serial = 0
    exists = os.path.isfile("VoterDetails\VoterDetails.csv")
    if exists:
        with open("VoterDetails\VoterDetails.csv", 'r') as csvFile1:
        ...
        with open("VoterDetails\VoterDetails.csv", 'a+') as csvFile1:
...
def TrackImages():
    ...
    ts = time.time()
    date = datetime.datetime.fromtimestamp(ts).strftime('%d-%m-%Y')
    exists = os.path.isfile("Votes\Votes_" + date + ".csv")
    if exists:
        with open("Votes\Votes_" + date + ".csv", 'a+') as csvFile1:
            writer = csv.writer(csvFile1)
        ...
        with open("Votes\Votes_" + date + ".csv", 'a+') as csvFile1:
            ...
            writer.writerow(attendance)
        csvFile1.close()
    with open("Votes\Votes_" + date + ".csv", 'r') as csvFile1:
        reader1 = csv.reader(csvFile1)
...
message3 = tk.Label(window, text="Face Recognition Based Voting System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
lbl3 = tk.Label(frame1, text="Votes",width=20  ,fg="black"  ,bg="#00aeff"  ,height=1 ,font=('times', 17, ' bold '))
...
trackImg = tk.Button(frame1, text="Take Face ", command=TrackImages  ,fg="black"  ,bg="yellow"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
